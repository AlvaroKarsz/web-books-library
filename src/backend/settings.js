...
module.exports = new function() {
  ...
  this.SOURCE_CODE_BACKEND_ADVANCED_ROUTE_FILE_NAME = 'advance.js';
  this.SOURCE_CODE_BACKEND_BOOKS_ROUTE_FILE_NAME = 'books.js';
  this.SOURCE_CODE_BACKEND_FINDERS_ROUTE_FILE_NAME = 'finders.js';
  this.SOURCE_CODE_BACKEND_GENERAL_ROUTE_FILE_NAME = 'general.js';
  this.SOURCE_CODE_BACKEND_PURCHASED_ROUTE_FILE_NAME = 'purchased.js';
  this.SOURCE_CODE_BACKEND_READS_ROUTE_FILE_NAME = 'reads.js';
  this.SOURCE_CODE_BACKEND_SERIES_ROUTE_FILE_NAME = 'series.js';
  this.SOURCE_CODE_BACKEND_STATIC_ROUTE_FILE_NAME = 'static.js';
  this.SOURCE_CODE_BACKEND_STORIES_ROUTE_FILE_NAME = 'stories.js';
  this.SOURCE_CODE_BACKEND_WEBSOCKET_ROUTE_FILE_NAME = 'websocket.js';
  this.SOURCE_CODE_BACKEND_WISHES_ROUTE_FILE_NAME = 'wishes.js';
  ...
  this.SOURCE_CODE_BACKEND_ADVANCED_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_ADVANCED_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_BOOKS_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_BOOKS_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_FINDERS_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_FINDERS_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_GENERAL_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_GENERAL_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_PURCHASED_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_PURCHASED_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_READS_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_READS_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_SERIES_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_SERIES_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_STATIC_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_STATIC_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_STORIES_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_STORIES_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_WEBSOCKET_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_WEBSOCKET_ROUTE_FILE_NAME);
  this.SOURCE_CODE_BACKEND_WISHES_ROUTE_FILE_PATH = path.join(this.SOURCE_CODE_BACKEND_ROUTES_PATH, this.SOURCE_CODE_BACKEND_WISHES_ROUTE_FILE_NAME);
