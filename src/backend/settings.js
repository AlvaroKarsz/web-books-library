...
module.exports = new function() {
  ...
  this.SOURCE_CODE_FRONTEND_WEBSOCKET_FILE_NAME = 'websocket.js';
  this.SOURCE_CODE_FRONTEND_MARK_BOOK_READ_FILE_NAME = 'markBookAsRead.js';
  ...
  this.SOURCE_CODE_FRONTEND_WEBSOCKET_FILE_PATH = path.join(this.SOURCE_CODE_FRONTEND_PATH, this.SOURCE_CODE_FRONTEND_WEBSOCKET_FILE_NAME);
  this.SOURCE_CODE_FRONTEND_MARK_BOOK_READ_FILE_PATH = path.join(this.SOURCE_CODE_FRONTEND_PATH, this.SOURCE_CODE_FRONTEND_MARK_BOOK_READ_FILE_NAME);
